...
let children_regexps : (string * Run.exp option) list = [
  ...
  "yul_identifier", None;
  "string_literal_fragment_double", None;
  "storage_location",
  Some (
    Alt [|
  ...
  "string_literal_fragment_single", None;
  "uint",
  Some (
    Alt [|
      Token (Literal "uint");
  ...
  Some (
    Alt [|
      Token (Name "pat_e8d4492");
      Token (Name "pat_f85f0d1");
    |];
  );
  "hex_string_literal",
  Some (
  ...
  Some (
    Alt [|
      Seq [
        ...
        Repeat (
          Alt [|
            Token (Name "string_literal_fragment_double");
            Token (Name "escape_sequence");
          |];
        );
        Token (Literal "\"");
      ...
      Seq [
        ...
        Repeat (
          Alt [|
            Token (Name "string_literal_fragment_single");
            Token (Name "escape_sequence");
          |];
        );
        Token (Literal "'");
...
let trans_string_literal_fragment_double ((kind, body) : mt) : CST.string_literal_fragment_double =
  match body with
  | Leaf v -> v
  | Children _ -> assert false
...
let trans_pat_f85f0d1 ((kind, body) : mt) : CST.pat_f85f0d1 =
  match body with
  | Leaf v -> v
  | Children _ -> assert false
...
let trans_pat_e8d4492 ((kind, body) : mt) : CST.pat_e8d4492 =
  match body with
  | Leaf v -> v
  | Children _ -> assert false
...
let trans_string_literal_fragment_single ((kind, body) : mt) : CST.string_literal_fragment_single =
  match body with
  | Leaf v -> v
  | Children _ -> assert false
...
let trans_decimal_number ((kind, body) : mt) : CST.decimal_number =
  ...
  | Children v ->
      ...
      | Alt (0, v) ->
          `Pat_e8d4492 (
            trans_pat_e8d4492 (Run.matcher_token v)
          )
      | Alt (1, v) ->
          `Pat_f85f0d1 (
            trans_pat_f85f0d1 (Run.matcher_token v)
          )
      | _ -> assert false
      )
  | Leaf _ -> assert false
...
let trans_string_ ((kind, body) : mt) : CST.string_ =
  ...
  | Children v ->
      (match v with
      | Alt (0, v) ->
          `DQUOT_rep_choice_str_lit_frag_double_DQUOT (
            (match v with
            | Seq [v0; v1; v2] ->
                (
                  Run.trans_token (Run.matcher_token v0),
                  Run.repeat
                    (fun v ->
                      ...
                      | Alt (0, v) ->
                          `Str_lit_frag_double (
                            trans_string_literal_fragment_double (Run.matcher_token v)
                          )
                      | Alt (1, v) ->
                          `Esc_seq (
                            trans_escape_sequence (Run.matcher_token v)
      ...
      | Alt (1, v) ->
          `SQUOT_rep_choice_str_lit_frag_single_SQUOT (
            (match v with
            | Seq [v0; v1; v2] ->
                (
                  Run.trans_token (Run.matcher_token v0),
                  Run.repeat
                    (fun v ->
                      ...
                      | Alt (0, v) ->
                          `Str_lit_frag_single (
                            trans_string_literal_fragment_single (Run.matcher_token v)
                          )
                      | Alt (1, v) ->
                          `Esc_seq (
                            trans_escape_sequence (Run.matcher_token v)
  ...
  | Children v ->
      ...
      | Seq [v0; v1; v2] ->
          (
            ...
            | Alt (1, v) ->
                `LCURL_opt_name_value_rep_COMMA_name_value_opt_COMMA_RCURL (
                  (match v with
                  | Seq [v0; v1; v2] ->
                      (
                        Run.trans_token (Run.matcher_token v0),
                        Run.opt
                          (fun v ->
                            ...
                            | Seq [v0; v1; v2] ->
                                (
                                  trans_name_value (Run.matcher_token v0),
                                  Run.repeat
                                    (fun v ->
                                      (match v with
                                      | Seq [v0; v1] ->
                                          (
                                            Run.trans_token (Run.matcher_token v0),
                                            trans_name_value (Run.matcher_token v1)
                                          )
                                      | _ -> assert false
                                      )
                                    )
...
and trans_name_value ((kind, body) : mt) : CST.name_value =
  match body with
  | Children v ->
      (match v with
      | Seq [v0; v1; v2] ->
...
and trans_return_type_definition ((kind, body) : mt) : CST.return_type_definition =
  match body with
  | Children v ->
      (match v with
      | Seq [v0; v1] ->
...
let trans_variable_declaration_tuple ((kind, body) : mt) : CST.variable_declaration_tuple =
  ...
  | Children v ->
      ...
      | Alt (1, v) ->
          `LPAR_opt_rep_COMMA_var_decl_rep_COMMA_opt_var_decl_RPAR (
            (match v with
            | Seq [v0; v1; v2; v3; v4] ->
                (
                  Run.trans_token (Run.matcher_token v0),
  ...
  | Children v ->
      ...
      | Seq [v0; v1; v2] ->
          (
            ...
            | Alt (2, v) ->
                `Var_decl_tuple (
                  trans_variable_declaration_tuple (Run.matcher_token v)
                )
            | _ -> assert false
            )
            ,
...
and trans_statement ((kind, body) : mt) : CST.statement =
  ...
  | Children v ->
      ...
      | Alt (1, v) ->
          `Unch_blk (
            trans_unchecked_block (Run.matcher_token v)
          )
      | Alt (2, v) ->
          `Exp_stmt (
            trans_expression_statement (Run.matcher_token v)
...
and trans_unchecked_block ((kind, body) : mt) : CST.unchecked_block =
  match body with
  | Children v ->
      (match v with
      | Seq [v0; v1] ->
          (
            Run.trans_token (Run.matcher_token v0),
            trans_block_statement (Run.matcher_token v1)
          )
      | _ -> assert false
      )
  | Leaf _ -> assert false
